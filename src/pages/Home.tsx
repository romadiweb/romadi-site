...
export default function Home() {
    return (
        ...
        <meta property="og:title" content="Pielāgotas mājaslapas, dizains un SEO – Romadi" />
        <meta property="og:description" content="Romadi palīdz uzņēmumiem augt tiešsaistē – ar web dizainu, izstrādi un digitālo stratēģiju. Saskarē ar kvalitāti." />
