...
export default function TopBanner({ visible, onClick }: TopBannerProps) {
    ...
    return (
        <div
        onClick={onClick}
        className={`w-3/4 bg-[#dfd9d7] text-black rounded-b-md text-sm py-2 px-4 z-[65] border-b border-neutral-300 cursor-pointer flex items-center justify-center gap-2 hover:bg-[#E7E2E0] transition-all duration-500
